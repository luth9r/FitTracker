...
/// <summary>
///     Handles <see cref="UserRegisteredEvent" /> by sending a localized HTML email with verification link to the newly
///     registered user.
/// </summary>
...
public sealed class SendVerificationEmailHandler(
    ...
    ILogger<SendVerificationEmailHandler> logger) : INotificationHandler<UserRegisteredEvent>
{
    /// <summary>
