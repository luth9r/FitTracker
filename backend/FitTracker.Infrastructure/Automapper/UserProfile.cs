    ...
    public class UserProfile : Profile
    {
        public UserProfile()
        {
            ...
            CreateMap<UserEf, User>()
                .ConstructUsing(src => new User(src.Username, src.Email, src.PasswordHash, src.FirstName, src.LastName, src.Avatar, src.Bio, UnitSystem.FromString(src.PreferredUnits)));
        }
    }
}
